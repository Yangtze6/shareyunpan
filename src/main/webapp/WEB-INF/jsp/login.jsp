	...
	<div class="slider">
		<ul class="slider-main">
			<li class="slider-panel"><a href="#" ><img
					alt="共享云盘" title="共享云盘" src="${pageContext.request.contextPath }/img/1.jpg"></a></li>
			<li class="slider-panel"><a href="#" ><img
					alt="共享云盘"   src="${pageContext.request.contextPath }/img/2.jpg"></a></li>
			<li class="slider-panel"><a href="#" ><img
					alt="共享云盘" title="共享云盘" src="${pageContext.request.contextPath }/img/3.jpg"></a></li>
			<li class="slider-panel"><a href="#" ><img
					alt="共享云盘" title="共享云盘" src="${pageContext.request.contextPath }/img/4.jpg"></a></li>
		</ul>
